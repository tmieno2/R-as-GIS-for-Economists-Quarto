...
```{r}
data(NIR)
terra::writeRaster(as(NIR, "SpatRaster"), "Data/NIR.tif")

data(RED)
terra::writeRaster(as(RED, "SpatRaster"), "Data/RED.tif")
```
...
terra::writeRaster(as(prism_saunders, "SpatRaster"), "Data/prism_saunders.tif")
terra::writeRaster(as(prism_douglas, "SpatRaster"), "Data/prism_douglas.tif")
```
